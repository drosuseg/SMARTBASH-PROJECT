  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="flex items-center justify-center py-12 px-4">
        <FormContainer
          title="Welcome Back"
          subtitle="Sign in to your SMARTBASH account"
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="button"
              className="w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 transition flex items-center justify-center gap-3"
            >
